"""Class that extracts common functionality for Molecular Analysis Run Item entity"""  

from .seqdbapi import SeqDBApi	

class MolecularAnalysisRunItemApi(SeqDBApi):
  ...
  def __init__(self, base_url: str = None) -> None:
    ...
    self.base_url += "molecular-analysis-run-item"
