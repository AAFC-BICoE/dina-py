"""Class that extracts common functionality for controlled vocabulary entity"""
import json
import logging
from .collectionapi import CollectionModuleApi

class ControlledVocabularyItemAPI(CollectionModuleApi):
	...
	def __init__(self, base_url: str = None) -> None:
		...
		self.base_url += "controlled-vocabulary-item"
	
	def create_entity(self, json_data):
		"""Creates a DINA controlled vocabulary entity
	...
	def get_entity_by_field(self, field, value):
		"""Retrieves a DINA controlled vocabulary entity by it's field
	...
	def bulk_update(self, json_data: dict) -> dict:
		"""Updates controlled-vocabulary records providing a bulk payload using a PATCH request.

		Parameters:
			json_data (dict): JSON data for updating the controlled-vocabulary.
