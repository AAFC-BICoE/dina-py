...
class MaterialSampleSchema(Schema):
	...
	hierarchy = SkipUndefinedField(fields.List, fields.Dict, allow_none=True, attribute="attributes.hierarchy")
	targetOrganismPrimaryScientificName = SkipUndefinedField(fields.Str, allow_none=True, attribute="attributes.targetOrganismPrimaryScientificName")
	targetOrganismPrimaryClassification = SkipUndefinedField(fields.Dict, allow_none=True, attribute="attributes.targetOrganismPrimaryClassification")
	effectiveScientificName = SkipUndefinedField(fields.Str, allow_none=True, attribute="attributes.effectiveScientificName")
