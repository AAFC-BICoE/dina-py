...
def build_samples_xml_from_models(samples: List[Sample]) -> str:
    """
    Build ENA SAMPLE_SET XML from multiple Sample Pydantic models (batch submission).
    
    This allows submitting multiple samples in a single XML submission to ENA,
    which is more efficient than individual submissions.
    
    Args:
        samples: List of Sample Pydantic models
        
    Returns:
        XML string with SAMPLE_SET containing multiple SAMPLE elements
    """
    NSMAP = {
        "xsi": "http://www.w3.org/2001/XMLSchema-instance",
        "com": "SRA.common",
